...
import { Info, Layout, Layers, MessageSquare, ShieldCheck, Edit } from 'lucide-react'
        ...
        >
          {data.status}
            ...
            <div className='flex justify-end'>
                <Link href={`/app/rcs/templates/create?edit=true&id=${id}`}>
                    <Button className='w-24' variant={'default'} >
                        <span className='flex gap-2 items-center'>
                            <Edit height={15} width={15} /><p className='font-light'>Edit</p>
                        </span>
                    </Button>
                </Link>
            </div>
